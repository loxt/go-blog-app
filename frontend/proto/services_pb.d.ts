...
export class UsernameUsedRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: UsernameUsedRequest
  ): UsernameUsedRequest.AsObject;
  static serializeBinaryToWriter(
...
export class EmailUsedRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: EmailUsedRequest
  ): EmailUsedRequest.AsObject;
  static serializeBinaryToWriter(
...
export class AuthUserResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: AuthUserResponse
  ): AuthUserResponse.AsObject;
  static serializeBinaryToWriter(
